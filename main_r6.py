...
def display_connected_areas():
    ...
    black_area = calculate_connected_areas('black')  # 黑子的標籤為1
    white_area = calculate_connected_areas('white')  # 白子的標籤為2
    print('black_area', black_area, 'white_area', white_area)
...
def select_hexes_by_random(hexes_by_label, current_round):
    selected_hexes = MCTS.next_action(hexagon_board, current_round)
    return selected_hexes
